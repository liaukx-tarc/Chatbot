...
data_file = open('order_intents.json').read()
...
pickle.dump(words, open('order_words.pkl', 'wb'))
pickle.dump(classes, open('order_classes.pkl', 'wb'))
...
# save the model
model.save('order_chatbot_model.h5', hist)
