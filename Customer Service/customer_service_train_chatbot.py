...
data_file = open('customer_service_intents.json').read()
...
pickle.dump(words, open('customer_service_words.pkl', 'wb'))
pickle.dump(classes, open('customer_service_classes.pkl', 'wb'))
